...
//     public void processCompanyRecords(MultipartFile file) {
...
//                 EquityDataDTO equityData = EquityDataDTO.builder()
//                     .symbol(getCellValue(row.getCell(0)))
//                     .name(getCellValue(row.getCell(1)))
//                     .series(getCellValue(row.getCell(2)))
//                     .isin(getCellValue(row.getCell(3)))
//                     .faceValue(getNumericCellValue(row.getCell(4)))
//                     .industry(getCellValue(row.getCell(5)))
//                     .instrumentType(getCellValue(row.getCell(6)))
//                     .build();
